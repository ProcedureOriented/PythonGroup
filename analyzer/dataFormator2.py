        ...
        with open('./%s' %(filename), 'r', encoding='utf_8_sig') as f:
            ...
            while line:     #当line不为EOF
                ...
                if line[:2] == '内容':
                    ...
                    result=[keyword, content, date]   #生成数据记录
